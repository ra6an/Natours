...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoicmE2YW4iLCJhIjoiY2wwcXNpZWNhMmF0ODNkdW91MDY0OXBtdSJ9.F8e8MLAZYex5xV3gkS6jWg'; // BUG sredit na mapbox siteu
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status = 'success') {
              ...
              location.assign('/');
            } // if (!token || req.cookies.jwt === 'loggedout') location.reload(true);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You created account successfuly!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "You successufly updated your ".concat(type.toUpperCase(), "!")); // location.assign('/me');
            }
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Email is sent successfully! Check out your Email inbox.');
            }
...
var resetPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(password, passwordConfirm) {
    var token, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            token = location.pathname.split('/').pop(); // console.log(token);
            ...
            return (0, _axios.default)({
              ...
              data: {
                password: password,
                passwordConfirm: passwordConfirm // token
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'You successfully reset your password!');
              location.assign('/');
            }
          ...
          case 8:
            _context.prev = 8;
            _context.t0 = _context["catch"](0);
            showAllert('error', _context.t0.response.data.message);
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"getMyReviews.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderReviews = exports.getTour = exports.getMyReviews = void 0;
...
var getMyReviews = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://127.0.0.1:3000/api/v1/reviews' // responseType: 'json'
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'Error getting my reviews');
...
var renderReviews = function renderReviews(data, tour) {
  var container = document.querySelector('.user-view__content-3');
  var reviewDate = data.createdAt.split('T')[0]; // console.log(reviewDate);
  // const dataTour = dataTwo;

  var html = "\n  <div class=\"line\">&nbsp;</div>\n  <div class=\"review-user\">\n    <div class=\"review-header__flex\">\n      <a class=\"review-link\" href=\"/tour/".concat(tour.slug, "\">\n        <h2 class=\"heading-tour__review\">").concat(tour.name, "</h2>\n      </a>      \n      <a class=\"review-delete__btn\">\n        <svg class=\"review-icon\">\n          <use xlink:href='img/icons.svg#icon-delete'></use>\n        </svg>\n      </a>\n    </div>\n        \n    <div class=\"rev-text__user\">\n      <p class=\"review-text__user\">").concat(data.review, "</p>\n      <p class=\"review-date__user\">").concat(reviewDate, "</p>\n    </div>\n  </div>\n  "); // svg
...
exports.renderReviews = renderReviews;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: "http://127.0.0.1:3000/api/v1/tours/".concat(id)
            });
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'Error getting all tours');
...
var stripe = Stripe('pk_test_51Kf2lnGUM5AlmTkrLWNFKfwIuvgeSwAf4ABuEIZ9X0OQtfQI5yKiyiKyZtYCWGuVJ4Tsh4EdBwBsIw58PqJWznB8003Xc41FxB');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) sreate checkout form + charge the credit card
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"myBookings.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.renderBookings = exports.getMyBookings = void 0;
...
var getMyBookings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', 'There is no bookings!');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            _context2.prev = 9;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', 'There is no tours!');
...
var renderBookings = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(data, tourId) {
    var container, tour, html;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            container = document.querySelector('.user-view__content-2');
            _context3.next = 4;
            return getTour(tourId);

          case 4:
            tour = _context3.sent;
            console.log(tour); // const reviewDate = data.createdAt.split('T')[0];
            // console.log(reviewDate);
            // const dataTour = dataTwo;

            html = "\n      <div class=\"line\">&nbsp;</div>\n      <div class='card booked__card'>\n        <div class='card__header'>\n          <div class='card__picture'>\n            <div class='card__picture-overlay'>&nbsp</div>\n            <img class='card__picture-img' src='img/tours/".concat(tour.imageCover, "' alt='").concat(tour.name, "' />\n          </div>\n          <h3 class='heading-tertirary'>\n          <span>").concat(tour.name, "</span>\n          </h3>\n        </div>\n        <div class='card__details'>\n\n          <h4 class='card__sub-heading'>").concat(tour.difficulty, " ").concat(tour.duration, "-day tour</h4>\n          <p class='card__text'>").concat(tour.summary, "</p>\n          <div class='card__data'>\n            <svg class='card__icon'>\n              <use xlink:href='img/icons.svg#icon-map-pin'></use>\n            </svg>\n            <span>").concat(tour.startLocation.description, "</span>\n          </div>\n\n          <div class='card__data'>\n            <svg class='card__icon'>\n              <use xlink:href='img/icons.svg#icon-calendar'></use>\n            </svg>\n            <span>").concat(tour.startDates[0].split('T')[0], "</span>\n          </div>\n\n          <div class='card__data'>\n            <svg class='card__icon'>\n              <use xlink:href='img/icons.svg#icon-flag'></use>\n            </svg>\n            <span>").concat(tour.locations.length, " size</span>\n          </div>\n\n          <div class='card__data'>\n            <svg class='card__icon'>\n              <use xlink:href='img/icons.svg#icon-user'></use>\n            </svg>\n            <span>").concat(tour.maxGroupSize, " people</span>\n          </div>\n\n        </div>\n        <div class='card__footer'>\n          <a class='btn btn--green btn--small' href='/tour/tour.slug'>Booked</a>\n        </div>\n      \n      </div>\n    "); //         .card__details
          ...
          case 10:
            ...
            (0, _alerts.showAlert)('error', 'There is a problem with rendering bookings!');
  ...
  return function renderBookings(_x2, _x3) {
    return _ref3.apply(this, arguments);
  };
}();

exports.renderBookings = renderBookings;
...
var _getMyReviews = require("./getMyReviews");

var _stripe = require("./stripe");

var _myBookings = require("./myBookings");
...
var loginAndSignupForm = document.querySelector('.form');
...
var forgotPasswordForm = document.querySelector('.forgot__password-form');
var resetPasswordForm = document.querySelector('.reset__password-form');
var userView = document.querySelector('.user-view');
var userOptions = document.querySelectorAll('.liste');
var forLoop = document.querySelectorAll('.for__loop');
...
if (loginForm) {
  loginAndSignupForm.addEventListener('submit', function (e) {
    e.preventDefault();
...
if (resetPasswordForm) {
  loginAndSignupForm.addEventListener('submit', function (e) {
    ...
    (0, _resetPassword.resetPassword)(password, passwordConfirm); // console.log(password);
  });
}
...
if (userView) {
  ...
  (function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(userId) {
      var reviews, myReviews, bookings;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              _context5.next = 2;
              return (0, _getMyReviews.getMyReviews)();
            ...
            case 2:
              ...
              myReviews.forEach( /*#__PURE__*/function () {
                  ...
                  return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                      switch (_context2.prev = _context2.next) {
                        case 0:
                          _context2.next = 2;
                          return (0, _getMyReviews.getTour)(el.tour);

                        case 2:
                          tour = _context2.sent;
                          // RENDERING REVIEWS
                          (0, _getMyReviews.renderReviews)(el, tour);
              ...
              _context5.next = 8;
              return (0, _myBookings.getMyBookings)();

            case 8:
              bookings = _context5.sent;
              console.log(bookings); // RENDER BOOKINGS

              bookings.forEach( /*#__PURE__*/function () {
                var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(el) {
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          ...
                          _context3.next = 3;
                          return (0, _myBookings.renderBookings)(el, el.tour.id);
              ...
              userOptions.forEach(function (els) {
                return els.addEventListener('click', /*#__PURE__*/function () {
                  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(el) {
                    var element, dataSet, content;
                    return regeneratorRuntime.wrap(function _callee4$(_context4) {
                      while (1) {
                        switch (_context4.prev = _context4.next) {
                          case 0:
                            el.preventDefault();
                            element = el.target.closest('.liste');
                            dataSet = element.dataset.set;
                            userOptions.forEach(function (e) {
                              return e.classList.remove('side-nav--active');
                            });
                            forLoop.forEach(function (e) {
                              return e.classList.add('hidden');
                            });
                            content = document.querySelector(".user-view__content-".concat(dataSet));
                            content.classList.remove('hidden');
                            element.classList.add('side-nav--active'); // const attribute = element.querySelector('a').getAttribute('href');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "62223" + '/');
